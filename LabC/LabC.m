...
outp_2 = polyfit(h_2_V, h_2, 2);

u = [0.5,1,1.5,2,2.5,3,3.5,5,8,10];
q = [16.47,20.75,24.52,27.63,30.06,32.49,34.80,40.28,48.24,52.43];
...
A = [-(a_1 + Al_0)*g/At/sqrt1, 0,               -sqrt1/At;
     a_1*g/At/sqrt1,           -a_2*g/At/sqrt2, 0;
     0,                        0,               0];
B = [dq_0/At; 0; 0];
C = [0 1 0];
D = 0;
